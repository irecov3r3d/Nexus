...
class BMCReportGenerator:
    ...
    def __init__(self, required_keywords: List[str] = ["cloud", "AI", "enterprise", "API", "RAG"]):
        ...
        self._required_keywords_lower = [k.lower() for k in required_keywords]
    ...
    def _calculate_factual_grounding(self, content: str) -> int:
        ...
        found_count = sum(1 for keyword_lower in self._required_keywords_lower if keyword_lower in content_lower)
